...
function Map:init()
    ...
    while x <= self.mapWidth do
        ...
        if x < self.mapWidth - 2 and math.random(20) == 1 and x ~= self.mapWidth - 5 then
        ...
        if x == self.mapWidth - 4 then
            ...
            x = x + 1
        elseif x >= self.mapWidth - 15 and x <= self.mapWidth - 10 then
            for y = self.mapHeight / 2 - (x - self.mapWidth + 15), self.mapHeight do
                self:setTile(x, y, TILE_BRICK)
            end
            x = x + 1
        else
            ...
            elseif math.random(10) == 1 and x < self.mapWidth - 3 and x ~= self.mapWidth - 16 and x ~= self.mapWidth - 5 then
